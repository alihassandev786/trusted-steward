...
class ResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bottomSafeArea > 10 ? bottomSafeArea + 10 : 22.0;
                  ...
                  stats.length,
                    ...
                    return Padding(
                      padding: EdgeInsets.only(
                        bottom: index == stats.length - 1 ? 0 : 12,
                      ),
                      child: _StatRow(stat: stats[index]),
                    );
                  },
                ),
...
class _StatRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final progress = stat.progress.clamp(0.0, 1.0).toDouble();
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _Palette.text.withOpacity(0.08),
          width: 1,
        ),
        boxShadow: [
          BoxShadow(
...
class BalanceResultScreen extends StatelessWidget {
  final VoidCallback onContinue;
